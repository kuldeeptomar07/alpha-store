        ...
        <jsp:include page="includesPage/_facebookJoin.jsp"></jsp:include>
            ...
            <div class="grid_13"  style="padding: 10px 0px;" id="whiteBox">
                ...
                <form method="post" action="admin_addProduct_controller.jsp">
                    ...
                    <div class="grid_5">
                        <input id="companyName" type="text" name= "companyName" placeholder="Publisher Company Name here"/>
                    </div>
                    <div class="grid_2">
                    ...
                    <div class="clear"></div><br/>
                    <div class="grid_7">
                        <input id="addProductNameBtn" class="buy" type="button" value="Add Publisher  Company"/>
