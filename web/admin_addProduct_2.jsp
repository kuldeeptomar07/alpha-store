...
%>
            ...
            <div class="grid_13"  style="padding: 10px 0px;" id="whiteBox">
                ...
                <form method="post" action="admin_addProduct_controller.jsp">
                    ...
                    <div class="grid_5">
                        <input id="categoryName" type="text" name= "categoryName" tabindex="1" placeholder="eg. Engineering, Medical, School"/>
                    </div>
                    <div class="grid_2">
                    ...
                    <div class="grid_5">
                        <input id="SubCategoryName"  type="text" name= "SubCategoryName" tabindex="1" placeholder="Computer/IT, MBA, BDS, etc"/></div>
                    <div class="grid_2">
