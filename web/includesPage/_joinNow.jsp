    ...
    <div class="container_16">
        <div id="LoginBox" class="grid_16">
                ...
                <form autocomplete="false" method="post" action="loginServlet"  name="login">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <label><input type="email" name="email" placeholder="kuldeep@xyz.com" required/><br/></label>
                            </td>
                        </tr>
                        <tr>
                            <td>
            ...
            <div class="grid_6 push_2" id = "RegisterForm">
                <form autocomplete="false" method="POST" action="registerServlett" name="registerServlett">
                    <table>
                        <tr>
                            <td colspan="2">
                        ...
                        <tr>
                            ...
                            <td>
                                <label><input type="email" name="emailReg" placeholder="kuldeep@xyz.com" required/><br/></label>
                            </td>
                        </tr>
                        <tr>
                            <td>
